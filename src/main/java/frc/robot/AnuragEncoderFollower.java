 ...
 * @author Jaci
 */
public class AnuragEncoderFollower {
    ...
    public AnuragEncoderFollower(Trajectory traj) {
        this.trajectory = traj;
    }

    public AnuragEncoderFollower() { }
    ...
    public double calculate(int encoder_tick) {
        ...
        double distance_covered = ((double)(encoder_tick - encoder_offset) / encoder_tick_count)
                * wheel_circumference;
        if (this.segment < trajectory.length()) {
